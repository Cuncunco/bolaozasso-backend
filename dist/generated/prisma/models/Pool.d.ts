...
export type PoolWhereInput = {
    ...
    title?: Prisma.StringFilter<"Pool"> | string;
...
export type PoolScalarWhereWithAggregatesInput = {
    ...
    title?: Prisma.StringWithAggregatesFilter<"Pool"> | string;
...
export type PoolOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "code" | "createdAt", ExtArgs["result"]["pool"]>;
...
export interface PoolFieldRefs {
    ...
    readonly title: Prisma.FieldRef<"Pool", 'String'>;
