...
export async function poolRoutes(fastify) {
    fastify.get("/pools/count", { preHandler: [requireAuth] }, async (request) => {
    ...
    fastify.get("/pools", { preHandler: [requireAuth] }, async (request) => {
        const userId = request.userId;
    ...
    fastify.post("/pools", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    fastify.post("/pools/join", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    fastify.get("/pools/:poolId", { preHandler: [requireAuth] }, async (request, reply) => {
    ...
    fastify.delete("/pools/:poolId", { preHandler: [requireAuth] }, async (request, reply) => {
